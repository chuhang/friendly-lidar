...
<center>
<img src="./eqs/eq13.png" width="450">
</center>
...
We prototyped this method in Matlab and tested it, the run time on KITTI is 5 seconds per frame. Note that this is maximum resolution setting, in a not so efficient scripting language, and without parallelization (though every step is easily parallelizable).

Want to know the final performance? Want to use the optimized c-library? Want to find out how are we using this to improve detection and segmentation? Stay tuned!